...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json(['success' => true, 'message' => "Tải dữ liệu thành công", 'data' => $categorys], 200);
    }
    ...
    public function show($id)
    {
        ...
        return response()->json(['success' => true, 'message' => "Tải dữ liệu thành công", 'data' => $category], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->status = $request->status; //form
        $category->save(); //Luuu vao CSDL
        return response()->json(['success' => true, 'message' => 'Thành công', 'data' => $category], 200);
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        return response()->json(['message' => 'Thanh cong', 'success' => true, 'id' => $category], 200);
